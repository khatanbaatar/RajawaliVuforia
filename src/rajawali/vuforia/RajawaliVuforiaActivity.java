...
public abstract class RajawaliVuforiaActivity extends RajawaliActivity {
	...
	private class InitCloudRecoTask extends AsyncTask<Void, Integer, Boolean> {
		...
		protected void onPostExecute(Boolean result) {
			...
			if (result) {
				...
				AlertDialog dialogError = new AlertDialog.Builder(RajawaliVuforiaActivity.this).create();
	...
	protected void onDestroy() {
		...
		if (mInitCloudRecoTask != null && mInitCloudRecoTask.getStatus() != InitCloudRecoTask.Status.FINISHED) {
	...
	protected native int setVirtualButtonOnDataSet(String dataSetFile, int idx, String targetNmae, String buttonName,
	...
	public static boolean loadLibrary(String nLibName) {
		try {
			...
			RajLog.e("The library lib" + nLibName + ".so could not be loaded");
		} catch (SecurityException se) {
			RajLog.e("The library lib" + nLibName + ".so was not allowed to be loaded");
		}
